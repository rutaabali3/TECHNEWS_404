...
TECHNEWS_404 is a GitHub-only technology news digest. A GitHub Actions job checks the public TechCrunch RSS feed every 30 minutes, adds newly published articles to a persistent queue, publishes one queued article at a time after a 90-minute cooldown, stores structured records in `data/posts.json`, and deploys the static site through GitHub Pages.
